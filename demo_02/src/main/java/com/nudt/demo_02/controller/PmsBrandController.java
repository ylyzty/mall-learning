...
import com.nudt.demo_02.common.CommonPage;
...
public class PmsBrandController {
    ...
    public CommonResult<List<PmsBrand>> getBrandList() {
        return CommonResult.success(pmsBrandService.getAllPmsBrand());
    }
    ...
    public CommonResult<PmsBrand> getBrand(@PathVariable("id") Long id) {
        CommonResult commonResult;
        PmsBrand pmsBrand = pmsBrandService.getBrandById(id);
        if (pmsBrand != null) {
            commonResult = CommonResult.success(pmsBrand);
    ...
    public CommonResult<CommonPage<PmsBrand>> listBrand(
        ...
        List<PmsBrand> brandList = pmsBrandService.getPmsBrandPaging(pageNum, pageSize);
        return CommonResult.success(CommonPage.paging(brandList));
    }
}
